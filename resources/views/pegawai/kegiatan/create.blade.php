...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			<div class="card-body">
                <form action="{{ route('kegiatan.store') }}" method="POST" id="kegiatan.store">
                    @csrf
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="card-body">
                            ...
                            <div class="form-row mt-3">
                                <div class="form-group col">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control bg-white" name="kegiatan" id="datepicker">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control bg-white" name="volume" id="jadwal_kerja">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <div class="input-group">    
                                        ...
                                        <input type="text" class="form-control bg-white" name="satuan">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <div class="input-group">    
                                        ...
                                        <input type="text" class="form-control bg-white" name="keluaran" id="total_lph">
                                        <x-validate-error-message name="keluaran"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 d-flex align-items-end flex-column">
