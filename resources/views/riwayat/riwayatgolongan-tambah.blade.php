      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card">
            <div class="card-header">
              <h2>
                    <button type="button" class="btn btn-primary mx-1 float-right" onclick="location.href='{{ route('profil') }}'"><i class="fas fa-arrow-left"></i></button>
                      Tambah Data Riwayat Golongan
                  </h2>
              </div>
              <div class="card-body">
                <form method="POST" action="{{ route('riwayat-golongan.store') }}">
                  @csrf
