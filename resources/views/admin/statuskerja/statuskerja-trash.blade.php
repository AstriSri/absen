            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            @foreach($statuskerja as $i)
                            <tr>
                                <td>{{ $loop->iteration}}</td>
                                <td>{{ $i->status}}</td>
                                <td>{{ $i->kode}}</td>
                                <td>
                                    <form method="POST" action="{{url('admin/statuskerja/'.$i->id.'/restore')}}">
                                        @csrf
                                        @method("PUT")
                                ...
                                <td>
                                    <form method="POST" action="{{url('admin/statuskerja/'.$i->id.'/delete_per')}}">
                                        @csrf
                                        @method("DELETE")
