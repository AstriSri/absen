      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="card">
            <div class="card-header">
              <h2>
                <button type="button" class="btn btn-primary mx-1 float-right text-white" onclick="location.href='{{ route('dosen.show', $dosen->id) }}'"><i class="fas fa-arrow-left"></i></button>
                  Tambah Data Dokumen
              </h2>
              </div>
              <div class="card-body">
                <form method="POST" action="{{ route('dosen.dokumen.store', $dosen->id) }}" enctype="multipart/form-data">
                  @csrf
