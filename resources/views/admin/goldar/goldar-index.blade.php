    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-header">
                <h2>
                    Data Golongan Darah
                    <a class="btn btn-danger mx-1 float-right" href="{{ url('admin/trash/goldar/index') }}"><i class="fas fa-trash-restore"></i></a>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $i->goldar}}</td>
                                <td>{{ $i->kode}}</td>
                                <td><button type="button" class="btn btn-warning" onclick="location.href='{{ route('goldar.edit', $i->id) }}'"><i class="far fa-edit"></button></td>
                                <td>
                                    <form method="POST" action="{{route('goldar.destroy', $i->id)}}">
                                        @csrf
                                        @method("DELETE")
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form method="POST" action="{{ route('goldar.index') }}">
            <div class="modal-body">
                @csrf
                <label for="npm">Nama Golongan Darah</label>
                <div class="form-group">
                    <div class="form-line">
                        <input type="text" name="goldar" class="form-control" value="" required>
