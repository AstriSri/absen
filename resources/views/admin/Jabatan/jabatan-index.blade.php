    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-header">
                <h2>
                    Data Jabatan
                    <a class="btn btn-danger mx-1 float-right" href="{{ url('admin/trash/jabatan/index') }}"><i class="fas fa-trash-restore"></i></a>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $i->kode}}</td>
                                <td>{{ $i->keterangan}}</td>
                                <td><button type="button" class="btn btn-warning" onclick="location.href='{{ route('jabatan.edit', $i->id) }}'"><i class="far fa-edit"></button></td>
                                <td>
                                    <form method="POST" action="{{route('jabatan.destroy', $i->id)}}">
                                        @csrf
                                        @method("DELETE")
