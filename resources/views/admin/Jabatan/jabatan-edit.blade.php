  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        <div class="card-header">
            <h2>
              <a class="btn btn-primary mx-1 float-right" href="{{ route('jabatan.index') }}"><i class="fas fa-arrow-left"></i></a>
                Edit Data Jabatan
            </h2>
        </div>
        <div class="card-body">
          <form method="POST" action="{{ route('jabatan.update',$jabatan->id) }}">
            ...
            @method("PUT")
              ...
              <div class="form-group">
                 <div class="form-line">
                    <textarea name="keterangan" maxlength="300" rows="3" class="form-control" placeholder="">{{$jabatan->keterangan}}</textarea>
                 </div>
               </div>
