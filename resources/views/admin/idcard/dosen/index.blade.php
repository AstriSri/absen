...
<div class="row clearfix">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			<div class="card-body">
				<form id="idcard-form" method="POST" action="{{ route('cetakIdcardDosen') }}" enctype="multipart/form-data" target="_blank">
					@csrf
						...
						<table class="table table-bordered table-striped table-hover table dataTable js-exportable" id="myTable">
							<thead>
								<tr>
									...
									<th class="text-center">
										<h6 class="d-inline-block">Homebase</h6></th>
									<th class="text-center">
										<h6 class="d-inline-block">Status Dosen</h6></th>
									<th class="text-center">
										<h6 class="d-inline-block">Status Aktif</h6></th>
									<th class="text-center">
										<h6>Aksi</h6>
									</th>
								</tr>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href='{{url("admin/dosen/$i->id/idcard/show")}}' class="btn btn-warning">Lihat</a>
									</td>
								</tr>
								@endforeach
							</tbody>
