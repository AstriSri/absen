    ...
    <div class="card">
        <div class="card-header">
            <h2>
              ...
              <a class="btn btn-danger mx-1 float-right" href="{{ route('statusaktifdosen.index') }}"><i class="fas fa-arrow-left"></i><span> Kembali</span></a>
            </h2>
        </div>
        <div class="card-body">
          <form method="POST" action="{{ route('statusaktifdosen.update',$status->id) }}">
            @csrf
            @method("PUT")
