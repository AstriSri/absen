...
class RiwayatJabatanDosenController extends Controller
{
    /**
    ...
    {
        $data["jabatan"] = sip_jabatan_fungsional::whereNull('deleted_at')->orderBy('jabatan', 'asc')->get();
        return view('riwayat.dosen-riwayatjabatan-tambah', $data);
    }
    ...
    {
        $data["jabatan"] = sip_jabatan_fungsional::whereNull('deleted_at')->orderBy('jabatan', 'asc')->get();
        $data["riwayatjabatandosen"] = sip_riwayatjabatandosen::findOrfail($id);

        return view('riwayat.dosen-riwayatjabatan-edit', $data);
    }
